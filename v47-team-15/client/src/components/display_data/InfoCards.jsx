            ...
            <div className="flex flex-row items-center justify-center gap-2">
                <div className="min-w-[15rem] bg-[#1D2A41] rounded p-4">
                    ...
                    <div className="flex flex-row gap-4">
                        ...
                        <span className="bg-[#1F3A43] rounded text-[#34B349] px-1">1.00%</span>
                    </div>
                </div>
                <div className="min-w-[15rem] bg-[#1D2A41] rounded p-4">
                    ...
                    <div className="flex flex-row gap-4">
                        ...
                        <span className="bg-[#1F3A43] rounded text-[#34B349] px-1">37.1%</span>
                    </div>
                </div>
                <div className="min-w-[15rem] bg-[#311B3D] rounded p-4">
                    ...
                    <div className="flex flex-row gap-4">
                        <span>47.8%</span>
                        <span className="bg-[#461E3C] rounded text-[#F02934] px-1">0.31%</span>
                    </div>
                </div>
            </div>
        </div>
